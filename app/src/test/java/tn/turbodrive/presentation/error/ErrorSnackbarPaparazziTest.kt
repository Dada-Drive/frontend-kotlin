package tn.turbodrive.presentation.error
...
import tn.turbodrive.presentation.components.designsystem.DesignSnackbar
import tn.turbodrive.presentation.components.designsystem.DesignSnackbarVariant

/**
 * Snapshot coverage for the error snackbar in FR (LTR) and AR (RTL) — the two
 * primary locales for TurboDrive Tunisia. Validates that:
