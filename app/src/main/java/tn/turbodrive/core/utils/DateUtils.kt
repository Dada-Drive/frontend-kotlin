...
object DateUtils {
    ...
    ): String = SimpleDateFormat(PATTERN_DATE, locale).format(date)
    ...
    fun formatDateTime(
        date: Date,
        locale: Locale = Locale.getDefault(),
    ): String = SimpleDateFormat(PATTERN_DATE_TIME, locale).format(date)
    ...
    fun formatTime(
        date: Date,
        locale: Locale = Locale.getDefault(),
    ): String = SimpleDateFormat(PATTERN_TIME, locale).format(date)
    ...
    fun parse(
        ...
        locale: Locale = Locale.getDefault(),
    ): Date? = runCatching { SimpleDateFormat(pattern, locale).parse(dateString) }.getOrNull()
