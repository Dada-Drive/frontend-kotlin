...
package tn.turbodrive.core.language
...
enum class AppLanguage(val rawValue: String) {
    ...
    fun layoutDirection(): LayoutDirection = if (this == ARABIC) LayoutDirection.Rtl else LayoutDirection.Ltr

    companion object {
        fun fromRawValue(raw: String): AppLanguage = entries.find { it.rawValue == raw } ?: SYSTEM
