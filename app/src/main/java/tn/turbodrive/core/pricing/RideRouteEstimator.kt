package tn.turbodrive.core.pricing
...
object RideRouteEstimator {
    ...
    fun haversineKm(
        a: GeoCoordinates,
        b: GeoCoordinates,
    ): Double = haversineKm(a.latitude, a.longitude, b.latitude, b.longitude)
...
data class RiderFareEstimate(
    ...
    val fareTnd: Double,
    val confidence: FareConfidence = FareConfidence.ESTIMATED,
)

enum class FareConfidence {
    ESTIMATED,
    CONFIRMED,
    NETWORK_FALLBACK,
}
