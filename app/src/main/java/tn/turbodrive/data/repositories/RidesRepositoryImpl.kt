...
import tn.turbodrive.data.network.model.RideStopRequestItemDto
...
import tn.turbodrive.data.network.model.extractRiderRides
...
class RidesRepositoryImpl
    ...
    constructor(
        ...
        ): Result<tn.turbodrive.domain.models.ActiveRide> =
            runCatching {
                api.requestRide(
        ...
        override suspend fun getDriverRatings(
            ...
            val stats =
                response.stats?.toDomain()
                    ?: tn.turbodrive.domain.models.DriverRatingsStats(avgRating = 0.0, totalRatings = 0)
            ratings to stats
        }
