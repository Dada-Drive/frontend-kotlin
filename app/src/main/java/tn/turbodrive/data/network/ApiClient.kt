package tn.turbodrive.data.network
...
import tn.turbodrive.data.network.model.PaginatedResponse
import tn.turbodrive.data.network.model.PaginationMeta
...
class ApiClient
    ...
    constructor(
        ...
        suspend fun <T : Any> request(
            ...
            withContext(Dispatchers.IO) {
                ...
                okHttpClient.newCall(builder.build()).execute().use { resp ->
                    ...
                    val root =
                        runCatching { JsonParser.parseString(bodyStr) }.getOrNull()?.asJsonObject
        ...
        suspend fun <T : Any> requestPaginated(
            endpoint: ApiEndpoint,
