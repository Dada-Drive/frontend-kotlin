package tn.turbodrive.data.network.cloudinary
...
class CloudinaryManager
    ...
    constructor(
        ...
        companion object {
            ...
            private const val UPLOAD_PRESET = "turbodrive_avatars"
         ...
         *
         * Exemple :
         *   https://res.cloudinary.com/dzmbdnhh4/image/upload/v1234/turbodrive_avatars/user_abc.jpg
         *   → turbodrive_avatars/user_abc
         */
        fun extractPublicId(cloudinaryUrl: String): String {
            return try {
                ...
                val relevant =
                    if (afterUpload.firstOrNull()?.matches(Regex("v\\d+")) == true) {
                        afterUpload.drop(1)
                    } else {
                        afterUpload
                    }
