...
import tn.turbodrive.presentation.common.dataOrNull
import tn.turbodrive.presentation.common.errorOrNull
import tn.turbodrive.presentation.common.isLoading
import tn.turbodrive.presentation.map.AppMapDisplayMode
import tn.turbodrive.presentation.map.HereMapViewComposable
import tn.turbodrive.presentation.map.MapFloatingControlsRow
import tn.turbodrive.presentation.map.MapViewModel
...
private fun CompleteResultOverlay(
    result: tn.turbodrive.domain.models.CompleteRideResult,
    onDismiss: () -> Unit,
    modifier: Modifier = Modifier,
) {
    val c = LocalAppColors.current
