...
import tn.dadadrive.data.storage.FontScaleRepository
...
class FontScaleViewModel @Inject constructor(
    ...
    val scaleFactor: StateFlow<Float> = fontScaleRepository.scaleFactor
        .stateIn(viewModelScope, SharingStarted.Eagerly, AppFontScalePreference.Default.scaleFactor)

    val preference: StateFlow<AppFontScalePreference> = fontScaleRepository.preference
