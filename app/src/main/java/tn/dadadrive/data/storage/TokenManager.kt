...
class TokenManager @Inject constructor(
    ...
    private val prefs: SharedPreferences = run {
        try {
            ...
            Log.i("DADADRIVE_BOOT", "TokenManager: chiffrement OK (EncryptedSharedPreferences)")
            p
        } catch (e: Exception) {
            Log.e(
                "TokenManager",
            ...
            Log.w("DADADRIVE_BOOT", "TokenManager: FICHIER CLAIR (fallback) — ${e::class.java.simpleName}")
    ...
    override fun isGuestBrowseEnabled(): Boolean =
