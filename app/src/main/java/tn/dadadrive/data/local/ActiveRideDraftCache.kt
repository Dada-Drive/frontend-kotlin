...
@Singleton
class ActiveRideDraftCache @Inject constructor(
    private val appDatabase: AppDatabase,
    private val gson: Gson,
) {

    suspend fun saveActiveOrClear(ride: ActiveRide?) = withContext(Dispatchers.IO) {
    ...
    suspend fun load(): ActiveRide? = withContext(Dispatchers.IO) {
    ...
    private companion object {
        private val PersistableStatuses = setOf(
            RideStatus.Pending,
