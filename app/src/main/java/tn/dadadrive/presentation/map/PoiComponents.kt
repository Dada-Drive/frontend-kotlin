...
@Composable
private fun localizedCategoryLabel(category: PoiCategory): String = when (category) {
...
internal fun PoiBottomSheet(
    ...
    val distanceText = if (userLocation != null && poiGeo != null) {
    ...
    val isPickupFlow = when (selectionTarget) {
